...
## Manually configure the register of the key value
USER_SET_REGISTER = 0x08
## Automatically configure the register of the key value
AUTUAL_SET_REGISTER = 0x09
## Get the register of the key value
